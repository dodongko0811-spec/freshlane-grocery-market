...
export const starterCatalog = [
  ...
  },
  {
    ...
    rating: 4.8,
    stock: 27,
    categoryLabel: resolveCategoryLabel('laundry'),
    image: makePackImage({
      title: 'DETERGENT',
      subtitle: 'LAUNDRY',
      bg: ['#eef2fb', '#dfe7f6'],
  ...
  {
    id: 'starter-paper-towels',
    source: 'starter',
    sourceId: 'starter-paper-towels',
    title: 'Paper Towels',
    description: 'Absorbent paper towels for spills, counters, and quick cleanup jobs.',
    category: 'household-paper',
    brand: 'FreshLane Home',
    price: 3.99,
    rating: 4.6,
  ...
  {
    id: 'starter-canned-fish',
    source: 'starter',
    sourceId: 'starter-canned-fish',
    title: 'Canned Sardines',
    description: 'Savory canned fish for rice meals, sandwiches, and pantry backups.',
    category: 'canned-fish',
    brand: 'FreshLane Pantry',
    price: 1.89,
    rating: 4.6,
    stock: 54,
    categoryLabel: resolveCategoryLabel('canned-fish'),
    image: makePackImage({
      title: 'SARDINES',
      subtitle: 'CANNED',
      bg: ['#eef3f8', '#d9e2ee'],
