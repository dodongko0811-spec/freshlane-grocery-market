import { buildFallbackProductImage, normalizeApiProduct, resolveCategoryLabel } from './storeUtils.js'
...
export const starterCatalog = [
  ...
  {
    id: 'starter-summer-sparkling',
    source: 'starter',
    sourceId: 'starter-summer-sparkling',
    title: 'Summer Sparkling Water',
    description: 'Light seasonal sparkling water for warm afternoons and family meals.',
    category: 'beverages',
  ...
  {
    id: 'starter-holiday-cookies',
    source: 'starter',
    sourceId: 'starter-holiday-cookies',
    title: 'Holiday Cookies',
    description: 'Seasonal bakery cookies for gifting, gatherings, and dessert trays.',
    category: 'bakery',
  ...
  },
  {
    id: 'starter-eggs',
    source: 'starter',
    sourceId: 'starter-eggs',
    title: 'Egg Tray',
    description: 'Fresh eggs for breakfast, baking, and everyday cooking.',
    category: 'dairy-eggs',
    brand: 'FreshLane Dairy',
    price: 4.29,
    rating: 4.7,
    stock: 64,
    categoryLabel: resolveCategoryLabel('dairy-eggs'),
    image: makePackImage({
      title: 'EGGS',
      subtitle: 'TRAY',
      bg: ['#f7f0df', '#ead8b8'],
  ...
  },
  {
    ...
    title: 'Fresh Milk',
    description: 'Cold milk for cereal, coffee, and family meals.',
    category: 'dairy-eggs',
    brand: 'FreshLane Dairy',
    price: 3.79,
    rating: 4.6,
  ...
  },
  {
    id: 'starter-pasta',
    source: 'starter',
    sourceId: 'starter-pasta',
    title: 'Spaghetti Pasta',
    description: 'Pantry pasta for quick dinners and family sauce nights.',
    category: 'foods-staples',
    brand: 'FreshLane Pantry',
    price: 2.69,
    rating: 4.6,
  ...
  },
  {
    id: 'starter-oil',
    source: 'starter',
    sourceId: 'starter-oil',
    title: 'Cooking Oil',
    description: 'Versatile cooking oil for frying, sautéing, and everyday recipes.',
    category: 'condiments',
    brand: 'FreshLane Pantry',
    price: 4.99,
    rating: 4.5,
  ...
  {
    id: 'starter-toothpaste',
    source: 'starter',
    sourceId: 'starter-toothpaste',
    title: 'Toothpaste',
    description: 'Daily oral care for family bathrooms and travel kits.',
    category: 'personal-care',
    brand: 'FreshLane Home',
    price: 2.99,
    rating: 4.6,
  ...
  },
  {
    id: 'starter-diapers',
    source: 'starter',
    sourceId: 'starter-diapers',
    title: 'Baby Diapers',
    description: 'Soft diapers for baby care, changing bags, and home shelves.',
    category: 'baby-care',
    brand: 'FreshLane Home',
    price: 12.49,
    rating: 4.7,
  ...
  },
  {
    ...
    rating: 4.5,
    stock: 33,
    categoryLabel: resolveCategoryLabel('pet-care'),
    image: makePackImage({
      title: 'CAT',
      subtitle: 'FOOD',
      bg: ['#eef0eb', '#dde3d6'],
  ...
  },
  {
    id: 'starter-apples',
    source: 'starter',
    sourceId: 'starter-apples',
    title: 'Apple Pack',
    description: 'Fresh and crisp apples, perfect for snacking or baking.',
    category: 'fresh-produce',
    brand: 'FreshLane Produce',
    price: 3.99,
    rating: 4.7,
    stock: 54,
    categoryLabel: resolveCategoryLabel('fresh-produce'),
    image: makePackImage({
      title: 'APPLE',
      subtitle: 'PACK',
      bg: ['#f7efe0', '#edd4b3'],
  ...
  },
  {
    id: 'starter-oranges',
    source: 'starter',
    sourceId: 'starter-oranges',
    title: 'Orange Bag',
    description: 'Sweet citrus oranges for juice, snacks, and lunchboxes.',
    category: 'fresh-produce',
    brand: 'FreshLane Produce',
    price: 4.49,
    rating: 4.6,
  ...
  },
  {
    id: 'starter-chips',
    source: 'starter',
    sourceId: 'starter-chips',
    title: 'Potato Chips',
    description: 'Crunchy snack chips for quick breaks and lunchbox treats.',
    category: 'snacks',
    brand: 'FreshLane Snacks',
    price: 2.59,
    rating: 4.4,
    stock: 70,
    categoryLabel: resolveCategoryLabel('snacks'),
    image: makePackImage({
      title: 'CHIPS',
      subtitle: 'SNACK',
      bg: ['#f7ecdf', '#ead6b5'],
...
export async function loadGroceryCatalog() {
  ...
  return (json.products || []).map((product) => {
    ...
    return {
      ...normalized,
      image: normalized.image || buildFallbackProductImage(normalized.title, normalized.categoryLabel),
    }
  })
}
