    ...
    <div className="page-stack">
      <section className="panel section-block store-hero">
        <SectionTitle
          ...
          text="The page works more like a catalog wall now: filters on the left, products on the right, and finer bakery, canned fish, laundry, and paper goods aisles up front."
        />
        ...
        <div className="store-layout">
          <aside className="store-rail">
            ...
            <article className="rail-card rail-card--accent">
              <p>Weekly Deal</p>
              <strong>Rice, drinks, bakery, canned fish, and essentials sit up front.</strong>
